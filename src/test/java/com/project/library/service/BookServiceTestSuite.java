...
public class BookServiceTestSuite {
    ...
    public void getAvailableBooks() {
        ...
        Book bookOne = new Book(1L, bookTitleOne, BookStatus.UNAVAILABLE, new ArrayList<>());
        Book bookTwo = new Book(2L, bookTitleOne, BookStatus.AVAILABLE, new ArrayList<>());
        Book bookThree = new Book(3L, bookTitleTwo, BookStatus.AVAILABLE, new ArrayList<>());
        //When
